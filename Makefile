...
PG_SHIPPED_ONLY_PKGS := ./cmd/msgvault ./cmd/msgvault-qdrant-seed ./cmd/msgvault/cmd ./internal/api ./internal/mcp ./internal/scheduler ./internal/store ./internal/vector/chunkmatch ./internal/vector/document ./internal/vector/embed ./internal/vector/hybrid ./internal/vector/pgvector ./internal/vector/qdrantindex ./scripts/contextual-retrieval-eval
